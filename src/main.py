    ...
    for i in range(N_EXPERIMENT_RUNS):
        ...
        for window_len in WINDOW_LENGTHS:
            ...
            for train_config in TRAIN_CONFIGS:
                ...
                model_path = train_model(path, train_config, depth_channel_representation_mode=DEPTH_CHANNEL_REPRESENTATION_MODE, multiple_digits=MULTIPLE_DIGITS, skip_if_exists=SKIP_IF_EXISTS, visualize_num=0, offset=OFFSET)
