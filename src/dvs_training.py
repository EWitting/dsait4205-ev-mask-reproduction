...
def train_model(data_path, fit_params, depth_channel_representation_mode, multiple_digits=False, pretrained_weights='coco', skip_if_exists=False, visualize_num=0):
